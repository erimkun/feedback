            ...
            <div className="flex flex-col items-center">
                ...
                <div className="w-full grid grid-cols-3 gap-2 text-center">
                    <div className="bg-green-50 rounded-lg p-3">
                        ...
                        <div className="text-xs text-green-700">Promoter (5)</div>
                    ...
                    <div className="bg-yellow-50 rounded-lg p-3">
                        ...
                        <div className="text-xs text-yellow-700">Passive (3-4)</div>
                    ...
                    <div className="bg-red-50 rounded-lg p-3">
                        ...
                        <div className="text-xs text-red-700">Detractor (1-2)</div>
                ...
                <div className="mt-4 text-xs text-gray-500 text-center">
                    NPS = % Promoter - % Detractor = {promoterPct}% - {detractorPct}% = <strong>{score}</strong>
                </div>
            </div>
        </div>
    );
